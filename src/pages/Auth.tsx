      ...
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">
            {mode === "signin" ? "Sign in to FreshMart" : "Join FreshMart for fresh groceries"}
          </p>
        </div>
        ...
        <div className="glass-card p-6">
          <button
            ...
            type="button"
            className="w-full h-11 rounded-lg bg-secondary border border-border hover:bg-primary/10 font-medium flex items-center justify-center gap-2 transition-all mb-4"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-12 rounded-lg bg-primary text-primary-foreground font-bold hover:brightness-110 transition-all disabled:opacity-50 glow-green"
            >
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            {mode === "signin" ? "New to FreshMart? " : "Already have an account? "}
            <button
              type="button"
